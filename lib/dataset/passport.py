...
from dataset.JointsDatasetPassport import JointsDatasetPassport
...
class PassportDataset(JointsDatasetPassport):
    ...
    def _do_python_keypoint_eval(self, res_file, res_folder):
        ...
        #####
        # Фикс для 6 точек
        coco_eval.params.kpt_oks_sigmas = np.array([0.05] * self.num_joints)
        #####
